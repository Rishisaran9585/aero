...
export default function VIPExperience() {
    ...
    return (
        <section className="pt-24 pb-24 bg-[#020202] relative overflow-hidden">
            {/* Background Texture */}
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col lg:flex-row justify-between items-end mb-6 md:mb-8 gap-6">
                    <div className="max-w-2xl">
                        ...
                        <motion.h2
                            ...
                            className="text-4xl md:text-7xl font-serif font-bold text-white leading-[0.8] tracking-tighter"
                        >
                    ...
                    <motion.div
                        ...
                        className="lg:w-1/3"
                    >
                        <p className="text-gray-500 text-base md:text-lg font-light leading-relaxed italic border-l border-white/10 pl-8">
                ...
                {/* THE PILLARS */}
                <div className="flex flex-col md:flex-row h-auto md:h-[50vh] min-h-[400px] gap-4">
                    {services.map((service, i) => (
                        <Link href="/contact" key={i} className="flex-1 flex">
                            <motion.div
                                ...
                                className="relative group rounded-[3rem] overflow-hidden cursor-pointer bg-[#0a0a0a] border border-white/5 w-full h-[300px] md:h-full"
                            >
                                {/* Background Image */}
                                <Image
                                    src={service.image}
                                ...
                                <div className="absolute inset-0 p-8 md:p-10 flex flex-col justify-between">
                                    ...
                                    <div>
                                        ...
                                        <h3 className="text-xl md:text-2xl lg:text-3xl font-serif font-bold text-white mb-2 transform group-hover:-translate-y-2 transition-transform duration-700">
                                            {service.title}
                                        </h3>
                                        ...
                                        <motion.div
                                            className="mt-4 md:mt-6 flex items-center gap-4 text-xs font-black uppercase tracking-widest text-secondary opacity-0 group-hover:opacity-100 transition-all"
                                        >
